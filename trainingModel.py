...
class trainModel:
    ...
    def __init__(self):
        ...
        self.file_object = open("C:\\Users\\sowmiya\\OneDrive\\Desktop\\code\\WaferFaultDetection_new\\Training_Logs\\ModelTrainingLog.txt", 'a+')
    ...
    def trainingModel(self):
        ...
        try:
            ...
            for i in list_of_clusters:
                ...
                train_x, test_x, train_y, test_y = train_test_split(cluster_features, cluster_label, test_size=1 / 3, random_state=355)
